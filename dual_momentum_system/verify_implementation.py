...
print("  • docs/dual-momentum-system/reference/VECTORIZED_BACKTESTING.md (comprehensive documentation)")
...
print("\n✓ Documentation:")
print("  • Detailed markdown guide (docs/dual-momentum-system/reference/VECTORIZED_BACKTESTING.md)")
...
print("  See docs/dual-momentum-system/reference/VECTORIZED_BACKTESTING.md for detailed documentation")
